return {
  {
    ...
    config = function()
      ...
      vim.api.nvim_set_keymap("i", "<S-C-J>", 'copilot#Accept("<CR>")', { silent = true, expr = true })
      ...
      vim.api.nvim_set_keymap(
        ...
        { desc = "Alt + '', request a suggestion even if Copilot is disabled" }
      )
      ...
      vim.api.nvim_set_keymap(
        ...
        { desc = "Accept one word of the current suggestion" }
      )
      vim.api.nvim_set_keymap(
        "i",
        "<M-C-l>",
        "<Plug>(copilot-accept-line)",
        { desc = "Accept the entire line of the current suggestion" }
      )
    end,
  },
}
